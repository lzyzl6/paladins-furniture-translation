...
public class TrashcanBlockEntityRenderer<T extends TrashcanBlockEntity> extends BlockEntityRenderer<T> {
    ...
    public TrashcanBlockEntityRenderer(BlockEntityRenderDispatcher ctx) {
        super(ctx);
    }
    @Override
    public void render(TrashcanBlockEntity trashcanBlockEntity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumerProvider, int light, int overlay) {
